"""Light, deterministic checks for document B revision 0.3.
...
def main():
    result = {"document": "B", "revision": "0.3", "date": "2026-09-08", "normalization": "gap=k_B=1; u_qp unit 4N0 gap^2; X_QP unit 4N0 gap",
