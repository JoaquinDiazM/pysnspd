...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_empalme_y_acoplamiento_etapa_3_20260923.pdf'
...
def main():
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Etapa 3 - Empalme y acoplamiento · 23 septiembre 2026')
    ...
    (DATA/'Informe_empalme_y_acoplamiento_etapa_3_20260923.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
