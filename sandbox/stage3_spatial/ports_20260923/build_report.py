...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_avance_bordes_etapa_3_20260923.pdf'
...
def main():
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Etapa 3 - Bordes y circuito · 23 septiembre 2026')
    ...
    (DATA/'Informe_avance_bordes_etapa_3_20260923.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
