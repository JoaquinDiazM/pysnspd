"""Render the results-only stage-1 report from its reviewed content record.
...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_etapa_1_catalogo.pdf'
...
def main():
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Etapa 1 · 11 septiembre 2026')
    ...
    (DATA/'Informe_etapa_1.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
