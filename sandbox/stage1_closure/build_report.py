"""Render the results-only stage-1 closure report from its reviewed content record.
...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_cierre_etapa_1.pdf'
...
def main():
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Cierre de etapa 1 · 21 septiembre 2026')
    ...
    (DATA/'Informe_cierre_etapa_1.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
