...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_revision_criterios_y_circuito_20260922.pdf'
...
def main():
    ...
    (DATA/'Informe_revision_criterios_y_circuito_20260922.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
