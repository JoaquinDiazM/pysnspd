"""Write the reviewed foreground handoff, retaining the prior notebook verbatim."""
from pathlib import Path
import hashlib,json
ROOT=Path(__file__).resolve().parents[3]
DATA=ROOT/'docs/implementation/stage2/closure_prep_20260922'
notebook=ROOT/'docs/GEMINGA_COMMANDS.md';archive=DATA/'GEMINGA_COMMANDS_before_mesh.md'
plan=json.loads((DATA/'guarded_acceptance_plan.json').read_text())
assert plan['status']=='READY_FOR_USER_FOREGROUND_RUN'
if not archive.exists():archive.write_bytes(notebook.read_bytes())
assert hashlib.sha256(archive.read_bytes()).hexdigest()=='68cf4dc7b9322a70baa798526565f9a0b42a604094a26c5c7cb318c9edf7f1ae'
