...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_etapa_2_celdas_acopladas.pdf'
...
def main():
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Etapa 2 - Celdas acopladas · 21 septiembre 2026')
    ...
    (DATA/'Informe_etapa_2_celdas_acopladas.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
