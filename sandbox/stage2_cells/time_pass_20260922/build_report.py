...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_resultados_temporales_etapa_2_20260922.pdf'
...
def main():
    ...
    (DATA/'Informe_resultados_temporales_etapa_2_20260922.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
