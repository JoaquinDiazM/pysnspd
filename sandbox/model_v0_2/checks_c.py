"""Reproducible, lightweight illustrative checks for document C revision 0.2.

No production solver, material tables, or detector transient is used.
Requires numpy, scipy and matplotlib. Outputs under docs/modelo_v0_2.
"""
