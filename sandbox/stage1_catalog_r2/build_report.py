"""Render the results-only stage-1 R2 report from its reviewed content record.
...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_etapa_1_r2.pdf'
...
def main():
    ...
    def p(text, style='body'):
        ...
        return Paragraph(text.replace('₀', '<sub>0</sub>'), styles[style])
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Etapa 1, R2 · 11 septiembre 2026')
    ...
    (DATA/'Informe_etapa_1_r2.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
