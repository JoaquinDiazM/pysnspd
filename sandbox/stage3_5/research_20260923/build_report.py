...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_investigacion_etapa_3_5_r1.pdf'
...
def main():
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Investigación de parámetros 3.5 · 23 septiembre 2026')
    ...
    (DATA/'Informe_investigacion_etapa_3_5_r1.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
