"""Render the stage-3.5 parameter research report from its reviewed content record.
...
OUTPUT = ROOT / 'output/pdf/implementation/Informe_cierre_investigacion_etapa_3_5.pdf'
...
def main():
    ...
    def footer(canvas, doc):
        ...
        canvas.drawString(17*mm, 10.5*mm, 'pySNSPD · Cierre de investigación 3.5 · 23 septiembre 2026')
    ...
    (DATA/'Informe_cierre_investigacion_etapa_3_5.md').write_text('\n'.join(markdown).rstrip()+'\n', encoding='utf-8')
    print(OUTPUT)
